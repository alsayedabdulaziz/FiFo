...
import 'consume_material_model.dart';
export 'consume_material_model.dart';

class ConsumeMaterialWidget extends StatefulWidget {
  const ConsumeMaterialWidget({super.key});

  @override
  State<ConsumeMaterialWidget> createState() => _ConsumeMaterialWidgetState();
}

class _ConsumeMaterialWidgetState extends State<ConsumeMaterialWidget> {
  late ConsumeMaterialModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConsumeMaterialModel());
